...
- [x] Frontend: flujos de login/registro + paneles para los 4 servicios + páginas de Horas (`Hours.jsx`), Evaluaciones (`Evaluations.jsx`), Documentos (`Documents.jsx`) y Notificaciones (`Notifications.jsx`) — verificado
